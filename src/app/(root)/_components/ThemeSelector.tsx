...
function ThemeSelector() {
  ...
  // function to solve the Hydration error //server rendered and client rendered theme is different
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {/* color indicator */}
        <div
          className="ralative w-4 h-4 rounded-full border border-gray-600 group-hover:border-gray-500 transition-colors"
